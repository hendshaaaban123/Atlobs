...
<body class="body-forms">
    ...
    <section class="login py-5 forms">
        <div class="container">
            <h2 class="text-center text-white">ATLOPS</h2>
            <h2 class="text-center text-white mb-5">أطلبس</h2>
            <div class="row">
                <div class="col-lg-7 col-md-4 empty"></div>
                <div class="col-lg-5 col-md-8 form-cont my-5">
                    @if (session('status'))
                    ...
                    <form method="POST" action="{{ route('password.email') }}"
                        ...
                        @csrf
                        <h3 class="modal-title w-100 fw-bold mb-3">{{ __('نسيت كلمه المرور') }}</h3>
                        <p>يرجي ادخال البريد الالكتروني لتتمكن من استعادة كلمة المرور لديك</p>
                        ...
                        <div class="text-center log m-auto mb-3 mt-4">
                            <button type="submit" class="btn py-2 text-light">{{ __('إرسال') }}</button>
                        </div>
